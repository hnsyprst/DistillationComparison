    ...
    def train_epoch_stage_1(self, net, train_set, loss_fn, optimizer):
        ...
        for features, labels in train_set:
            ...
            for count in range(len(self.hint_layers)):
                ...
                hint_start_layer_feature_map = self.feature_map['hint_start_%d' %count]
                hint_end_layer_feature_map = self.feature_map['hint_end_%d' %count]
                ...
                # and the FSP is calculated between them
                guided_start_layer_feature_map = self.feature_map['guided_start_%d' %count]
                guided_end_layer_feature_map = self.feature_map['guided_end_%d' %count]
